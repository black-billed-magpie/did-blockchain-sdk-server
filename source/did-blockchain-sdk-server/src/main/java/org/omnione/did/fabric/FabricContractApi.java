...
/**
 * The {@code FabricContractApi} class provides an implementation of the {@link ContractApi}
...
public class FabricContractApi implements ContractApi {
   ...
   *
   * @param resourcePath the path to the properties file containing the Fabric network
   *                     configuration
