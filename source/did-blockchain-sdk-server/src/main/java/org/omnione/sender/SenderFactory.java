 ...
 * <p>
 * This enum provides a way to instantiate the appropriate {@code OpenDidSender} implementation
 * based on the specified {@code BlockChainType}. Each enum constant is associated with a specific
 * blockchain type and a supplier for creating the corresponding sender instance.
 * </p>
 */
...
public enum SenderFactory {
   ...
   * <p>
   * This method retrieves the appropriate sender factory based on the provided blockchain type and
   * uses the associated supplier to create and return the {@code OpenDidSender} instance.
   * </p>
   *
   ...
   * @throws IllegalArgumentException if no matching sender factory is found for the given
   *                                  blockchain type
   */
